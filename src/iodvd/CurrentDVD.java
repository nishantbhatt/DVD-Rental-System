...
*/
public CurrentDVD(String title, double price, int count, DVDStatus status) throws DVDFormatException {

if(price < 0 || price > 999.99)
throw new DVDFormatException("DVD count must be between 0 - 999.99.");
if(title.length() > 25)
throw new DVDFormatException("DVD title must not be more than 25 characters.");
if(count < 0 || count > 9999)
throw new DVDFormatException("DVD quantity must be betwene 0 - 999.");
